...
public class StringBasicsPractice {
//	String str = "Kanmani";
	public static void main(String[] args) {
		String str = "Sathyamoorthy"; 
		String str1 = "Sathya";
		String str2 = "SATHYA";
		String str3 = "Shiva";
		StringBasicsPractice obj = new StringBasicsPractice();
//		System.out.println("The Length of the String is : ");
//		obj.getStringLength(obj.str);
//		System.out.println("Practice Length Method");
//		obj.practiceLengthMethod();
...
//		str.charAt(15);
		// StringIndexOutOfBoundsException - If we are passing a greater index value,then we will get this exception
